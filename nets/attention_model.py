...
class AttentionModel(nn.Module):
    ...
    def __init__(self,
        ...
        # Only keep padding problem
        assert problem.NAME == 'padding', "Only padding problem is supported"
        ...
        # Problem specific context parameters for padding problem
    ...
    def _init_embed(self, input):
        # For padding problem, just use the init_embed
    ...
    def _get_parallel_step_context(self, embeddings, state):
        """
        Returns the context per step for the padding problem
